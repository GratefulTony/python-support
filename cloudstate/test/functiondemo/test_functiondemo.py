...
from cloudstate.test.functiondemo.functiondemo2_pb2_grpc import \
    FunctionDemo2Stub
from cloudstate.test.functiondemo.functiondemo_pb2 import (AddToSum,
                                                           FunctionRequest,
                                                           FunctionResponse)
