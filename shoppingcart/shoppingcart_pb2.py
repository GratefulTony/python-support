...
from cloudstate import eventing_pb2 as cloudstate_dot_eventing__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'Z\020tck/shoppingcart',
  serialized_pb=b'\n\x1fshoppingcart/shoppingcart.proto\x12\x18\x63om.example.shoppingcart\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1b\x63loudstate/entity_key.proto\x1a\x19\x63loudstate/eventing.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x15google/api/http.proto\x1a\x19google/api/httpbody.proto\"X\n\x0b\x41\x64\x64LineItem\x12\x15\n\x07user_id\x18\x01 \x01(\tB\x04\x90\xb5\x18\x01\x12\x12\n\nproduct_id\x18\x02 \x01(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\x12\x10\n\x08quantity\x18\x04 \x01(\x05\";\n\x0eRemoveLineItem\x12\x15\n\x07user_id\x18\x01 \x01(\tB\x04\x90\xb5\x18\x01\x12\x12\n\nproduct_id\x18\x02 \x01(\t\"(\n\x0fGetShoppingCart\x12\x15\n\x07user_id\x18\x01 \x01(\tB\x04\x90\xb5\x18\x01\">\n\x08LineItem\x12\x12\n\nproduct_id\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x10\n\x08quantity\x18\x03 \x01(\x05\"9\n\x04\x43\x61rt\x12\x31\n\x05items\x18\x01 \x03(\x0b\x32\".com.example.shoppingcart.LineItem2\x9f\x03\n\x0cShoppingCart\x12y\n\x07\x41\x64\x64Item\x12%.com.example.shoppingcart.AddLineItem\x1a\x16.google.protobuf.Empty\"/\x82\xd3\xe4\x93\x02\x1e\"\x19/cart/{user_id}/items/add:\x01*\x9a\xb5\x18\x07\n\x05items\x12\x81\x01\n\nRemoveItem\x12(.com.example.shoppingcart.RemoveLineItem\x1a\x16.google.protobuf.Empty\"1\x82\xd3\xe4\x93\x02+\")/cart/{user_id}/items/{product_id}/remove\x12\x8f\x01\n\x07GetCart\x12).com.example.shoppingcart.GetShoppingCart\x1a\x1e.com.example.shoppingcart.Cart\"9\x82\xd3\xe4\x93\x02\x33\x12\x10/carts/{user_id}Z\x1f\x12\x16/carts/{user_id}/itemsb\x05itemsB\x12Z\x10tck/shoppingcartb\x06proto3'
  ,
  dependencies=[google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,cloudstate_dot_entity__key__pb2.DESCRIPTOR,cloudstate_dot_eventing__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_http__pb2.DESCRIPTOR,google_dot_api_dot_httpbody__pb2.DESCRIPTOR,])
...
_SHOPPINGCART = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\036\"\031/cart/{user_id}/items/add:\001*\232\265\030\007\n\005items',
  ),
  _descriptor.MethodDescriptor(
    name='RemoveItem',
    ...
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\202\323\344\223\002+\")/cart/{user_id}/items/{product_id}/remove',
  ),
  _descriptor.MethodDescriptor(
    name='GetCart',
    ...
    output_type=_CART,
    serialized_options=b'\202\323\344\223\0023\022\020/carts/{user_id}Z\037\022\026/carts/{user_id}/itemsb\005items',
  ),
])
